...
/**
 * The primary key class for the tklienciatrakcje database table.
 * 
 */
@Embeddable
public class TklienciatrakcjePK implements Serializable {
	...
	public TklienciatrakcjePK() {
	}

	public TklienciatrakcjePK(int iDAtrakcjiUslugi, int iDOsobyAtrakcji) {
		super();
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TklienciatrakcjePK)) {
			return false;
		}
		TklienciatrakcjePK castOther = (TklienciatrakcjePK) other;
